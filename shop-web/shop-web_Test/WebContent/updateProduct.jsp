...
<body>
	...
	<jsp:include page="header.jsp">  
			...
			<jsp:param name="current" value="UpdateProduct"/>
	</jsp:include> 
	<main>
		...
		<form method="post" action="Controller?action=ConfirmProductUpdate&oldProductId=${ID}" novalidate="novalidate">
			<!-- novalidate in order to be able to run tests correctly -->
			<p>
				<label for="productid">Product ID</label>
				<input type="text" id="productid" name="productid" required value="<c:out value="${ID}"/>" readonly>
			</p>
